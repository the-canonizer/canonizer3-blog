		...
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-12">
				<div class="footer_logo">
					...
					<p class="dis_text">
						Canonizer is an<a href="https://github.com/the-canonizer/canonizer-3.0-frontend" rel="noreferrer" target="_blank"> open source </a> project designed to build consensus and bring people together. Your collaboration can make all the difference. Join us!
					</p>
		...
		<div class="container">
			...
			<div class="col-md-12">
				...
				<?php if (empty($bug_blog_copyright_text)) : ?>
					<span class="footer-copyright">Copyright 2018 Canonizer.2.0<?php //echo sprintf(__('Copyright %s %s','bug-blog'), date('Y'), esc_url( home_url() )); 
																				?></span>
				<?php
				else :
				?>
